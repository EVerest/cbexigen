...
# xmldsig fragments which should be generated into en/decoder and datastructures.
# This reduces the size of the xmlsig frgment structure immensely for ISO15118-2 and -20.
# Usage e.g.:
# xmldsig_fragments = [
